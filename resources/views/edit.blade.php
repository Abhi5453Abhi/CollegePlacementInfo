...
<div class="background">
   ...
   <form method="POST" action="/edit" form id="login" class="input-group">
      ...
      <!-- <label class="input-name" > Edit Company Name: </label> -->
         <!-- <label>Company Name</label> -->
         <input type="hidden" name="email" value="{{$data->email}}">
         <label class="input-name"> Edit your company: </label>
         <!-- <select size="1" name="company_name" value="{{$data->company_name}}"  id="company_name" class="form-control"> -->
         <select size="1" name="company_name" id="company_name" class="form-control" value="{{$data->company_name}}">
         ...
         <br>
         <label class="input-name"> Edit Joining Month: </label>
         ...
         <br>
         <label class="input-name"> Edit Your Profile: </label>
         ...
         <label class="input-name">Edit Your Package: </label>
         <input type="number" name="package" id="package" class="form-control" value="{{$data->package}}"><br>
      ...
      <form method="POST" action="/edit" form id="register" class="input-group">
      @csrf
      <div class=form-group>
      <label class="input-name"> Enter CGPA </label>
         <input type="text" name="cgpa" class="form-control"><br>
